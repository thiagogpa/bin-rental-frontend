...
const Privacy = () => {
  return (
    <div>
      ...
      <p>
        This privacy policy will help you understand how we use and protect the
        data you provide to us when you visit and use its website and related
        services.
        <br />
      ...
      <p>
        ...
        your needs.
        <br />
        After we use the data for statistical analysis, the data is completely
      ...
      <p>
        ...
        for you.
        <br />
        We will not lease, sell or distribute your personal information to any
        third parties, unless we have your permission. <br />
        We might do so if the law forces us. Your personal information will be
        used when we need to send you promotional materials if you agree to this
        privacy policy.
      </p>
    </div>
  );
